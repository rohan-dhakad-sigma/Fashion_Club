...
<html lang="en">
<head>
<title>Fashion Club an Ecommerce Online Shopping Category  Flat Bootstrap responsive Website Template | Cosmetics :: w3layouts</title>
	...
	<div class="container">
		<div class="col-md-4 w3ls_dresses_grid_left">
				...
				<h3>Categories</h3>
					<div class="w3ls_dresses_grid_left_grid_sub">
						<div class="ecommerce_dres-type">
							<ul>
								<li><a href="cosmetics.php">Eye shades</a></li>
								<li><a href="cosmetics.php">Lipsticks</a></li>
								<li><a href="cosmetics.php">Eye makeup</a></li>
								<li><a href="cosmetics.php">Eye liner</a></li>
							</ul>
						</div>
					</div>
			</div>
			...
			<div class="w3ls_dresses_grid_left_grid">
				<div class="dresses_img_hover">
					<img src="images/offer8.jpg" alt=" " class="img-responsive" />
		...
		<div class="col-md-8 col-sm-8 women-dresses">
			...
			<div class="women-set3">
				...
				<a href="single.php"><div class="col-md-4 women-grids wp8 animated wow slideInUp" data-wow-delay=".5s">
