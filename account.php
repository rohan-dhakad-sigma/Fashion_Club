...
<form id="form1"  action="#">
    ...
    <input type="text" value="<?php echo $_SESSION['userfname'] ?>" name="firstname"><br><br>

    <label for="lastname">Last Name:</label>
    <input type="text" value="<?php echo $_SESSION['userlname'] ?>" name="lastname"><br><br>

    <label for="email">Email ID:</label>
    <input type="text" value="<?php echo $_SESSION['useremail'] ?>" name="email"><br><br>

    <label for="phone">Phone Number:</label>
    <input type="text" value="<?php echo $_SESSION['userphone'] ?>" name="phone"><br><br>
    ...
    <input type="text" value="<?php echo $_SESSION['usercity'] ?>" name="usercity"><br><br>
    
    <label for="userstate">State:</label>
    <input type="text" value="<?php echo $_SESSION['userstate'] ?>" name="userstate"><br><br>

    <label for="userzip">Zip Code:</label>
    <input type="text" value="<?php echo $_SESSION['userzip'] ?>" name="userzip"><br><br>

    <label for="usercountry">Country:</label>
    <input type="text" value="<?php echo $_SESSION['usercountry'] ?>" name="usercountry"><br><br>
