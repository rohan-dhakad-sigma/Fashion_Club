...
<form id="form1"  action="#">
	...
	<h3 class="h_info">Personal Information</h3>
	<div class="personal">

    <label for="firstname">First Name:</label>
    <input class="psame" type="text" value="<?php echo $_SESSION['userfname'] ?>" name="firstname"><br><br>

    <label for="lastname">Last Name:</label>
    <input class="psame"  type="text" value="<?php echo $_SESSION['userlname'] ?>" name="lastname"><br><br>

    <label for="email">Email ID:</label>
    <input class="email" type="text" value="<?php echo $_SESSION['useremail'] ?>" name="email"><br>

    <label for="phone">Number:</label>
    <input class="phone" type="text" value="<?php echo $_SESSION['userphone'] ?>" name="phone"><br><br>
    
    </div>
	
	<h3 class="h_info">Address Field</h3>
    <div class="address">

    <label for="address1">Address-1:</label>
    <input type="text" value="<?php echo $_SESSION['user_address1'] ?>" name="address1"><br><br>
    
    <label for="address2">Address-2:</label>
    <input type="text" value="<?php echo $_SESSION['user_address2'] ?>" name="address2"><br><br>

    <label for="usercity">City:</label>
    <input class="city" type="text" value="<?php echo $_SESSION['usercity'] ?>" name="usercity"><br><br>
    
    <label for="userstate">State:</label>
    <input class="state" type="text" value="<?php echo $_SESSION['userstate'] ?>" name="userstate"><br><br>

    <label for="userzip">Zip Code:</label>
    <input class="zip" type="text" value="<?php echo $_SESSION['userzip'] ?>" name="userzip"><br><br>

    <label for="usercountry">Country:</label>
    <input class="country" type="text" value="<?php echo $_SESSION['usercountry'] ?>" name="usercountry"><br><br>
...
<!-- Edit & Delete Button-->
<div class="button">
    <button class="edit" onclick="handle_edit()">Edit</button>
    <button class="delete" onclick="handle_delete()">Delete</button>  <br><br>
	<button class="add" onclick="handle_add()">Add</button> <br><br>
</div>
...
<script type="text/javascript">
	...
	function handle_add() {
		window.location.href = 'add_address1.php';
	}
